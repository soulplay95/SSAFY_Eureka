<template>
  <div>
    ...
    >
      <h2 class="l-text2 t-center">주문목록</h2>
    </section>
      ...
      <div class="container">
        ...
        >
          <div class="card-header">
            <strong>{{ $filters.date(order.order.order_date) }} 주문</strong
            >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!-- 배송지정보 보기 버튼 -->
            <svg
...
export default {
  ...
  created() {
    let userid = this.$store.getters['userStore/user'].member_userid; // 로그인된 유저 아이디
